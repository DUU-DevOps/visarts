...
import {Grid,  Fade, Link,  Avatar, Card, CardContent, CardMedia, Button } from '@mui/material';
            ...
            <div style = {{marginTop: "70px" }}>
                ...
                <Grid container justifyContent = "space-evenly" style = {{marginTop: "20px", marginBottom: "10px"}}>
                    {content.contacts.map((c) => {
                        return (
                            <Grid item xs = {12} sm = {3}  style = {{justifyContent: 'center', display: 'flex'}} raised component = {Card}>
                                    <CardContent>
                                        <CardMedia>
